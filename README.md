...
<img align="right" width="300" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/customer-navigation-manager-extension-for-magento-2/magento-2-customer-navigation-manager-small.png">  
  
[Customer Account Navigation Manager](https://www.jajuma.de/en/jajuma-develop/magento-extensions/customer-navigation-manager-extension-for-magento-2) extension by [JaJuMa](https://www.jajuma.de/) allows  
to configure and manage the Magento 2 customer account menu links from backend.  
Each link can be quickly and easily removed from your customer navigation dashboard sidebar in Magento.
...
* With Luma Frontend:  
  ...
  * Supports Removing / Sorting Following Tabs/Links: 
    * My Account
    * My Orders
...
```
composer require jajuma/customernavigation
```
...
* [Extension Website EN](https://www.jajuma.de/en/jajuma-develop/magento-extensions/customer-navigation-manager-extension-for-magento-2)
* [Extension Website DE](https://www.jajuma.de/de/jajuma-develop/magento-extensions/customer-navigation-manager-extension-fuer-magento-2)
...
* [Customer Navigation Manager Demo on Mage-OS](https://www.jajuma.de/en/jajuma-shop/demo-shop-with-mage-os-and-hyva-themes)
